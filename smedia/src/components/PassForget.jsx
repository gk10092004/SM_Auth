...
const PassForget = () => {
    ...
    const SendOtp = async(e) => {
        e.preventDefault();
        axios.post('https://sm-auth-11s9-server-ei2i5p00p-gaurav-kumars-projects-5d82833b.vercel.app/api/send-otp',{email})
        .then(async(result) => {
            if(result.data == "email found"){
                ...
                let data = await fetch("https://sm-auth-11s9-server-ei2i5p00p-gaurav-kumars-projects-5d82833b.vercel.app/api/send-otp")
    ...
    const UpdatePass = (e) => {
        ...
        if(password == confirmPass){
            axios.post('https://sm-auth-11s9-server-ei2i5p00p-gaurav-kumars-projects-5d82833b.vercel.app/api/password-reset',{email,password})
            .then(result => {
                navigate('/login')
            })
            .catch(err => console.log(err))
