...
const PassForget = () => {
    ...
    const SendOtp = async(e) => {
        e.preventDefault();
        axios.post('https://sm-auth-backend.vercel.app/api/send-otp',{email})
        .then(async(result) => {
            if(result.data == "email found"){
                ...
                let data = await fetch("https://sm-auth-backend.vercel.app/api/send-otp")
    ...
    const UpdatePass = (e) => {
        ...
        if(password == confirmPass){
            axios.post('https://sm-auth-backend.vercel.app/api/password-reset',{email,password})
            .then(result => {
                navigate('/login')
            })
            .catch(err => console.log(err))
